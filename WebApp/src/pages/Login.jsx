...
const LoginPage = () => {
  ...
  const { login, isLoading, loginError, loginErrorMessage, clearLoginError } =
    useAuth();
  ...
  const handleGuestLogin = async () => {
    ...
    // Use the login function from useAuth hook with guest credentials
    const response = await login("guest@admin.com", "guestpassword", "admin");
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <Link
                to="/Adminregister"
                className="text-[#7f56da] hover:underline"
              >
                Sign up
              </Link>
            </div>
