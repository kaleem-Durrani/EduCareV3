...
export const classService = {
  ...
  addTeacherToClass: (classId, teacherData) => api.post(`/classes/${classId}/teachers`, teacherData),
  removeTeacherFromClass: (classId, teacherId) => api.delete(`/classes/${classId}/teachers/${teacherId}`),
  addStudentToClass: (classId, studentData) => api.post(`/classes/${classId}/students`, studentData),
