...
export const CLASS_ENDPOINTS = {
  ...
  REMOVE_TEACHER: (classId, teacherId) => `/classes/${classId}/teachers/${teacherId}`,
...
export const STUDENT_ENDPOINTS = {
  ...
  GET_ENROLLMENT_HISTORY: (studentId) => `/student/${studentId}/enrollment-history`,
  TRANSFER_STUDENT: (studentId) => `/student/${studentId}/transfer`,
  WITHDRAW_STUDENT: (studentId) => `/student/${studentId}/withdraw`,
  GET_BASIC_INFO_PARENT: (studentId) => `/student/${studentId}/basic-info-parent`,
  GET_BASIC_INFO_TEACHER: (studentId) => `/student/${studentId}/basic-info-teacher`,
...
export const HEALTH_ENDPOINTS = {
  ...
  UPDATE_HEALTH_METRIC: (studentId, metricId) => `/health/metrics/${studentId}/${metricId}`,
