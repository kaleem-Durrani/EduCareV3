...
type ActivitiesScreenNavigationProp = StackNavigationProp<ParentStackParamList, 'Activities'>;
type ActivitiesScreenRouteProp = RouteProp<ParentStackParamList, 'Activities'>;
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        <VStack flex={1} p="$4" space="md">
          ...
          <Text fontSize="$md" color="$textLight600" $dark-color="$textDark400">
            This screen will display the student's activities.
          </Text>
        </VStack>
      </Box>
    </SafeAreaView>
