...
type MonthlyPlanScreenNavigationProp = StackNavigationProp<ParentStackParamList, 'MonthlyPlan'>;
type MonthlyPlanScreenRouteProp = RouteProp<ParentStackParamList, 'MonthlyPlan'>;

interface Props {
  navigation: MonthlyPlanScreenNavigationProp;
  route: MonthlyPlanScreenRouteProp;
}

const MonthlyPlanScreen: React.FC<Props> = ({ navigation, route }) => {
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        <VStack flex={1} p="$4" space="md">
          ...
          <Text fontSize="$md" color="$textLight600" $dark-color="$textDark400">
            This screen will display the student's monthly plan.
          </Text>
        </VStack>
      </Box>
    </SafeAreaView>
